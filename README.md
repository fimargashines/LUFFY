...
- OpenAI API integration is implemented; Gemini API integration remains a placeholder
- FSDP and distributed training features need completion


### 🔴 High Priority TODOs

- **API Integration**: OpenAI API integration is implemented; Gemini API implementation still needs completion
...
- **Data Processing**: Core batch dimension folding/unfolding are implemented; further tensor reshaping optimizations remain
